...
- [Unified Theory Research Framework](docs/UNIFIED_THEORY.md)
- [Unified-theory observables and cross-scale closure](docs/UNIFIED_THEORY_OBSERVABLES.md)
...
-> connection
-> coarse-graining
-> closure / memory / noise
-> effective laws
~~~

The immediate derivation target is to determine whether a minimal physical principle can force a two-component complex state, rather than assuming one in order to obtain SU(2).

The project does **not** currently claim to derive the Standard Model or general relativity from this structure.
